...
const EditGoal = ({ open, handleClose, goal, handleEditGoal, deleteGoal }) => {
  if (!goal) return null;
  ...
  const submitEdit = () => {
    ...
    console.log(goal);
    handleEditGoal(deadline, priority, goal);
    handleClose();
  };
      ...
      <Dialog open={open} onClose={handleClose}>
        ...
        <DialogContent>
          ...
          <Stack>
            ...
            >
              <ToggleButton value="weekly" sx={{ textTransform: "capitalize" }}>
                Weekly
              </ToggleButton>
              <ToggleButton
                value="monthly"
              ...
              <ToggleButton value="yearly" sx={{ textTransform: "capitalize" }}>
                Yearly
              </ToggleButton>
              <ToggleButton value="custom" sx={{ textTransform: "capitalize" }}>
                Custom
              </ToggleButton>
            </ToggleButtonGroup>
